...
from models.layers import DepthwiseSeparableConv, ResidualBlockDepthwise
...
class SmallMobileExtended(nn.Module):
    ...
    def __init__(self, in_channels : int = 3, num_class : int = 8):
        ...
        self.model = nn.Sequential(
            ...
            nn.BatchNorm2d(32),
            nn.ReLU(),
            ResidualBlockDepthwise(channels=32, kernel_size=3),
            ResidualBlockDepthwise(channels=32, kernel_size=3),
