...
from models.small_resnet import SmallResnetDepthwiseReduce
import utils
import torch
...
model = SmallResnetDepthwiseReduce()
...
wandb_logger = WandbLogger(
    project="C3-Week4",
    entity="mcv-team-6",
    name="ResnetReduced WDA depthwise"
)

wandb_logger.experiment.config.update({
                "architecture": "Small ResNet depthwise with end channel reduction",
                "epochs": EPOCHS,
                "image_size": IMG_SIZE,
                "learning_rate": LR,
                "parameters" : total
