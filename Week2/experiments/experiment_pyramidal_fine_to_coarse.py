...
from models.complex_models.pyramidal_dense_descriptor_classifier import make_pyramidal_fine_to_coarse
...
model = make_pyramidal_fine_to_coarse(dropout=DROPOUT)
...
run = utils.init_wandb_run(
    ...
    entity="mcv-team-6",
    project="C3-Week2",
    name=f"Pyramidal Fine-to-Coarse (dropout={DROPOUT} wd={WEIGHT_DECAY} ls={LABEL_SMOOTHING})",
    config={
        "architecture": "PyramidalFineToCoarse",
        "patch_structure": "2x2 -> 4x4 -> 7x7 -> 4x4",
        "channels": "3 -> 64 -> 256 -> 1024 -> 4096",
        "epochs": EPOCHS,
        "image_size": IMG_SIZE,
        "dropout": DROPOUT,
